...
extension JobService {
    ...
    static let sampleData: [JobService] = [
        JobService(
            ...
            someoneAround: true,
            specialTools: nil,
            serviceDate: Date(timeIntervalSinceNow: 86400 /* secondsPerDay */ * 3),
        ...
        JobService(
            ...
            image: ServiceImage(localId: nil, remoteURL: nil),
            createdAt: Date(timeIntervalSinceNow: -86400 /* secondsPerDay */),
            ...
            serviceDate: Date(timeIntervalSinceNow: 86400 /* secondsPerDay */ * 7),
        ...
        JobService(
            ...
            serviceDate: Date(timeIntervalSinceNow: 86400 /* secondsPerDay */ * 2),
        ...
        JobService(
            ...
            someoneAround: false,
            specialTools: nil,
            serviceDate: Date(timeIntervalSinceNow: 86400 /* secondsPerDay */ * 5),
        ...
        JobService(
            ...
            serviceDate: Date(timeIntervalSinceNow: 86400 /* secondsPerDay */ * 10),
            estimatedDurationHours: 8.0,
            applicationCount: 3
        )
    ]
